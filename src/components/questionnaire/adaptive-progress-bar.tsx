...
import { MAX_QUESTIONS, STATIC_QUESTIONNAIRE_ONLY } from "@/lib/engine/constants";
  ...
  return (
    <div className="space-y-2">
      <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-foreground/45">
        {STATIC_QUESTIONNAIRE_ONLY ? "Guided reflection" : phase === "foundation" ? "Foundation reflection" : "Adaptive reflection"}
      </p>
      <p className="text-xs font-semibold text-foreground/50">
        ...
        {STATIC_QUESTIONNAIRE_ONLY
          ...
          : phase === "foundation"
            ? " · Foundation"
            : ""}{" "}
        · {dimensionCoverage} dimensions explored
        {!STATIC_QUESTIONNAIRE_ONLY && phase !== "foundation"
